...
export class PlayerServiceService {
  ...
  async CreatePlayer(newPlayer: any) {
    try {
      ...
      const response = await axios.post('https://scoutify-secure-back.onrender.com/player', playerData);
  ...
  async getPlayerFollowed(): Promise<any> {
    try {
      ...
      const response = await axios.get('https://scoutify-secure-back.onrender.com/player', optionsLoad);
  ...
  async getPlayerById(playerId: string): Promise<any> {
    ...
    try {
      const response = await axios.get(`https://scoutify-secure-back.onrender.com/player/${playerId}`);
...
async deletePlayer(playerId: string): Promise<boolean> {
  try {
    const response = await axios.delete(`https://scoutify-secure-back.onrender.com/player/${playerId}`);
...
async updatePlayer(playerId: string, updatedPlayerData: any): Promise<boolean> {
  try {
    const response = await axios.put(`https://scoutify-secure-back.onrender.com/player/${playerId}`, updatedPlayerData);
